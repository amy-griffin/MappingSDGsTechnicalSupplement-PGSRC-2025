...
At the top of the screen, change from *No labels* to *Single labels*. Set the *Value* to *nam_en*.
...
A popup asks you to *Choose Primary Key*. Select *nam_en* and click *OK*.
