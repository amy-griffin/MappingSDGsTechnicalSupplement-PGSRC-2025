...
Because we only have a few hours for this workshop, I have already done this for you to save a little time. Remove the *BNDA_simplified* layer by right-clicking its name in the Layers and choosing *Remove Layer*.
