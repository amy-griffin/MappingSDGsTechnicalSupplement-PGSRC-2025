...
Next, download [the recentred data](https://www.naturalearthdata.com/) and save it to your *SDG_choropleth_tutorial* folder. Unzip the file and then follow these instructions: 
