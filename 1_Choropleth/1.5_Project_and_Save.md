...
Because this workshop is only a few hours, I have already done this for you to save a little time. Remove the *BNDA_simplified* layer by right-clicking its name in the Layers and choosingn *Remove Layer*.
