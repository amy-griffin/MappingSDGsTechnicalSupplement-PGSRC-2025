...
Look at the attribute table. Six countries should be selected. To see them, scroll over to the *unwp_2025* column and sort the column by values. Sort by clicking the column heading (the word *unwp_2025*). 
