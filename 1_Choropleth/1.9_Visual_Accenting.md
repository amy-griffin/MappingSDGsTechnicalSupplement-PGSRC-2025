...
Fill in the *Expression*. On the right panel, expand *Fields and Values* and double-click on *unwp_2025* to insert it into the expression. Then type *>= 50* and click *Select Features*. Click *Close*.

![](1.9_Visual_Accenting_images/image_2.png)

Look at the attribute table. Twelve countries should be selected. To see them, scroll over to the *unwp_2025* column and sort the column by values. Sort by clicking the column heading (the word *unwp_2025*). 
...
If necessary, move *UN_wom_par_fiftyplus* above *UN_wom_par_eiv* in the *Layers* panel to see it.
