...
This tutorial demonstrates how to download a Geodatabase with a world countries shapefile (.shp) directly from the UN. 

Download [the Geodatabase](https://geoportal.un.org/arcgis/apps/sites/#/geohub/datasets/33e5c17e2de94a75ae7fdb9395cd277f/about) from the UN Geospatial Hub by clicking the "Download" button. 
...
Under *Period* click *Range* and select *2025* as both the start year and end year. The Mapping for a Sustainable World book, whose map we are reproducing, mapped data from 2020. We will update this map with current data so we can look at whether the situation has changed!
